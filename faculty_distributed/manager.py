...
class FacultyJobExecutor:
    ...
    clean: bool, default=True
        If True, temporary directory used to pass files to and from workers will
        be removed once workers are finished. If False, temporary files will be
        left on the workspace.
    tmpdir_prefix: str, default=None
        Root directory for temporary directory to be created in. If None, temporary
        directory will be created in "/project/.faculty-distributed".
    """
